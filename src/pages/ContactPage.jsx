                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4 p-6 bg-[#1e293b] rounded-2xl border border-white/5 shadow-sm hover:shadow-lg transition-all card-hover group">
                                    <div className="w-12 h-12 bg-[#0a1929] rounded-xl flex items-center justify-center text-[#14b8a6] group-hover:scale-110 transition-transform">
                                    ...
                                    <div>
                                        ...
                                        <a
                                            ...
                                            className="text-xl font-bold text-[#14b8a6] hover:text-[#2dd4bf] transition-colors"
                                        >
                                            {contactInfo.phone}
                                        </a>
                                    </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid sm:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            required
                                            className="w-full px-5 py-4 rounded-2xl border border-gray-700 bg-[#0a1929]/50 text-white text-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-[#14b8a6] transition-all placeholder:text-gray-500"
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <div className="relative">
                                                <button
                                                    ...
                                                    className="w-36 px-4 py-4 rounded-2xl border border-gray-700 bg-[#0a1929]/50 text-white text-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-[#14b8a6] transition-all cursor-pointer flex items-center justify-between"
                                                >
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        required
                                        className="w-full px-5 py-4 rounded-2xl border border-gray-700 bg-[#0a1929]/50 text-white text-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-[#14b8a6] transition-all appearance-none cursor-pointer"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        required
                                        rows={6}
                                        className="w-full px-5 py-4 rounded-2xl border border-gray-700 bg-[#0a1929]/50 text-white text-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-[#14b8a6] transition-all resize-none placeholder:text-gray-500"
